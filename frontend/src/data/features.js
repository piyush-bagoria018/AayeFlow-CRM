...
export const features = [
  {
    title: "Lead Capture",
    description:
      "Every form submission lands in your pipeline automatically. No copy pasting from your inbox into a spreadsheet.",
    iconPath:
  ...
  },
  {
    title: "Deal Pipeline",
    description:
      "See every deal and which stage it is in. Drag a card forward when it moves, and the forecast updates itself.",
    iconPath:
  ...
  },
  {
    ...
    description:
      "One page per customer with every call, email and note your team has ever logged. Nobody has to ask what happened last time.",
    iconPath:
  ...
  },
  {
    ...
    description:
      "Know your conversion rate, average deal size and where deals go quiet, without building a single spreadsheet formula.",
    iconPath:
  ...
  },
  {
    ...
    description:
      "Assign owners, send follow up reminders and move stages on rules you set once. Your team does the selling, not the admin.",
    iconPath: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z",
  },
  {
    title: "Integrations",
    description:
      "Connects to the tools you already pay for, so your CRM matches reality instead of becoming another silo.",
    iconPath:
